...
//        Log.e("pix", w + " " + h + " " + pix.length);
        dest.getPixels(pix, 0, w, 0, 0, w, h);

        int wm = w - 1;
        int hm = h - 1;
        int wh = w * h;
        int div = radius_ + radius_ + 1;
        ...
        for (y = 0; y < h; y++) {
            ...
            for (x = 0; x < w; x++) {
                ...
                stackstart = stackpointer - radius_ + div;
                ...
                if (y == 0) {
                    vmin[x] = Math.min(x + radius_ + 1, wm);
                }
                p = pix[yw + vmin[x]];
